...
{
    #region Written by Nguyễn Anh Vũ: Các thành phần cơ bản của class logic
    ...
    class Logic
    {
        ...
        public static string Checker()
        {
            ...
            #region Written by Nguyễn Đình Hòa: Vòng lặp kiểm tra nếu đủ 3 thành phần
            {
        ...
        #region Written by Nguyễn Sanh Thịnh: Hàm tính toán và xuất kết quả
        // Ham Tinh toan tong.
